    ...
    <section className='bg-indigo-600 px-5 py-14 xl:px-32'>
      <div className="flex items-center justify-between">
        ...
        {articles.data.data.length !== 0 &&
          <Link href='/semua-berita' className="border-2 border-white py-2 px-6 text-white text-sm hover:text-indigo-600 hover:bg-white hover:duration-150">
            Selengkapnya
          </Link>
        }
      </div>
      ...
      {latestArticle ?
        <div className="grid lg:grid-cols-2 gap-4 mt-8">
          ...
          <section>
            ...
            {moreArticle && moreArticle.map((article) => (
              <Link key={article.hash} href={`/berita/${article.url}`} className="grid grid-cols-3 gap-3 mb-3 group">
                ...
                <div className="text-white col-span-2">
                  <h1 className="line-clamp-2 font-bold group-hover:underline group-hover:underline-offset-2">
                    {article.title}
                  </h1>
        ...
        : <div className="py-2 px-10 w-fit border-2 border-white text-white mx-auto mt-8">
