...
export default async function Journal() {
  const getJournals = await getJournal()

  return (
    <>
      <Navbar active="Jurnal"/>
      <main className="grid gap-6 mx-10 my-10 grid-cols-1 md:grid-cols-2 xl:grid-cols-3 lg:mx-48">
        {getJournals.data.data.length === 0
        ? <div className="col-span-3 py-2 px-10 w-fit border-2 border-indigo-600 text-indigo-600 mx-auto mt-8">
