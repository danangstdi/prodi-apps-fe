        ...
        <div className="flex justify-between flex-col xl:flex-row">
          <div className='flex items-center gap-14'>
            ...
            <ul className='flex flex-col gap-1 text-xs text-white'>
              ...
              {config.phone && <li>Phone: {config.phone}</li>}
            </ul>
          </div>
        ...
        <div className="text-white grid lg:grid-cols-4">
          <div className='mt-14'>
            ...
            <ul>
              ...
              <li className='mt-1'>
                <Link href='/biografi' className='text-sm hover:ml-2 hover:duration-300 hover:ease-in-out'>
                  Tentang Kami
                </Link>
              </li>
              <li className='mt-1'>
          ...
          <div className='mt-14'>
            ...
            <div className="card">
              <a href={config.instagram || "https://instagram.com/"} className="socialContainer containerOne">
              ...
              <a href={config.twitter || "https://xnxx.com"} className="socialContainer containerTwo">
              ...
              <a href={config.facebook || "https://facebook.com"} className="socialContainer containerThree">
              ...
              <a href={config.youtube || "https://youtube.com"} className="socialContainer containerFour">
